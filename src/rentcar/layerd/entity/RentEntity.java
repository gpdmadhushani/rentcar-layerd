...
public class RentEntity {
    ...
    public RentEntity(String id, String custID, Date fromDate, Date toDate, String carID, Double perdayrent, Double advance, Double refundDeposit, Double total, Double balance) {
        this.id = id;
        this.custID = custID;
    ...
    public String toString() {
        return "RentEntity{" + "id=" + id + ", custID=" + custID + ", fromDate=" + fromDate + ", toDate=" + toDate + ", carID=" + carID + ", perdayrent=" + perdayrent + ", advance=" + advance + ", refundDeposit=" + refundDeposit + ", total=" + total + ", balance=" + balance + '}';
    }
