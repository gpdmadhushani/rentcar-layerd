...
public class DeleteRentView extends javax.swing.JFrame {
 ...
 private RentDetailsController rentDetailsController;
    ...
    private void initComponents() {
        ...
        homepanel.add(custnictext, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 60, 360, 40));
        ...
        homepanel.add(btndelete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 320, 160, 50));
...
searchrent();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteRentView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void deleterent() {
       try {
            ...
            String resp= rentController.deleteRent(rentId);
