...
public class CarDto {
    ...
    public CarDto(String id, String category, String brand, String model, String transmission, String fualType, String vehicleNo, Integer year, Double perDayPrice) {
        this.id = id;
    ...
    public String toString() {
        return "CarDto{" + "id=" + id + ", category=" + category + ", brand=" + brand + ", model=" + model + ", transmission=" + transmission + ", fualType=" + fualType + ", vehicleNo=" + vehicleNo + ", year=" + year + ", perDayPrice=" + perDayPrice + '}';
    }
